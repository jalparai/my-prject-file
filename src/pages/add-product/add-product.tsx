...
import { addNewProduct, getAllAllergen, getAllCategories } from "./api";
...
const ProductAdd = () => {
  ...
  const decreaseQuantity = (index: number) => {
    ...
    setPriceDetails('quantity', qty, index);
      console.log("========quantityquantity====>",qty)
            ...
            <div className="row">
              <div className="col-lg-6">
                <div className="fields">
                  ...
                  <input type="text" name="" id="" placeholder="Product Name " className="input" onChange={(e) => handleLocale('title', e.target.value, 0)} />


                  <textarea name="" id="" className="text_area" onChange={(e) => handleLocale('description', e.target.value, 0)} placeholder="Write Description">
                  ...
                  <input type="text" name="" id="" placeholder="Stock Code " className="input" onChange={(e) => setStockCode(e.target.value)} />

                  <select name="Type" id="" className="add_language" onChange={(e) => setType(e.target.value)}>
                  ...
                  <select name="Categories" id="" className="add_language" onChange={(e) => setCategory(e.target.value)}>
                  ...
                  <select name="Allergens" id="" className="add_language" onChange={(e) => setAllergens(e.target.value)}>
                  ...
                  <input type="number" name="" id="" placeholder="Calorie" className="input" onChange={(e) => setCalories(e.target.value)} />
                  ...
                  <div>
                    <Form.Group className="mb-3 check_btn" controlId="formBasicCheckbox" >
                      ...
                      <div>
                        <Form.Check type="checkbox" label="Yes" onChange={(e) => setFavorite(e.target.checked)} />
                      </div>
                    </Form.Group>
                  </div>

                  <div>
                    <Form.Group className="mb-3 check_btn" controlId="formBasicCheckbox2" >
                      <label htmlFor="Add product to opportunity products?" className="mt-3">Add product to opportunity products?</label>
                      <div>
                        <Form.Check type="checkbox" label="Yes" onChange={(e) => setOpportunity(e.target.checked)} />
                      </div>
                    </Form.Group>
                  </div>
            ...
            <div>
              ...
              <label htmlFor="Active" className="mt-3 mb-3">Active</label>
                ...
                <Form.Group className=" " controlId="formBasicCheckbox3" >
                  <Form.Check type="checkbox" label="Waiter/Pos Odrer"  onChange={(e) => handleActiveList(e.target.checked, 1)}/>
                </Form.Group>
              <Form.Group className=" " controlId="formBasicCheckbox4" >
                  <Form.Check type="checkbox" label="Qr Code Order"  onChange={(e) => handleActiveList(e.target.checked, 2)} />    
              </Form.Group>
              <Form.Group className=" " controlId="formBasicCheckbox5 " >
              <Form.Check type="checkbox" label="Home delivery" onChange={(e) => handleActiveList(e.target.checked, 3)}/>
              </Form.Group>
              <Form.Group className=" " controlId="formBasicCheckbox6" >
              <Form.Check type="checkbox" label="Take away" onChange={(e) => handleActiveList(e.target.checked, 4)}/>
              </Form.Group>
              <Form.Group className=" " controlId="formBasicCheckbox7" >
              <Form.Check type="checkbox" label="Case sale" onChange={(e) => handleActiveList(e.target.checked, 5)}/>
              </Form.Group>
            </div>
            </div>
