...
import { getAllCategories, getAllProducts, updateProductSettingAPI } from "./api";
    ...
    <>
      <div>
        <div className="import_strip ">
          <div>
            <Button size="lg" className="product_add" onClick={handleButtonClick}>
              Add Product
            ...
            <Button size="lg" className="product_add">
              Edit Rank
            </Button>
          </div>
          ...
          <div>
            <button onClick={exportProducts} className="export_btn">Export<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
