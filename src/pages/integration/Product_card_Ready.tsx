...
const Product_card_Ready = () => {
  ...
  return (
    <div>
            <button onClick={handleOpen} className="hugin_product_card">
...
export default Product_card_Ready
